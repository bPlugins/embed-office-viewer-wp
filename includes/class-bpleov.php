...
class BPLEOV_Main {
    ...
    public function __construct() {
        ...
        add_action( 'wp_enqueue_scripts', [$this, 'bpleov_public_scripts'] );
    ...
    public function upgrade_notice() {
        ...
        <div class="eov_upgrade_notice <?php echo esc_attr( $is_office_viewer_page ? 'officeviewer' : 'settings' ) ?> ">
            <div class="flex">
                <img src="<?php echo esc_url( BPLEOV_PLUGIN_DIR . 'assets/images/icon.png' ) ?>" alt="Office Viewer" />
                <h3>Office Viewer</h3>
            </div>
            <p>The Ultimate Document Viewer Plugin for WordPress, Loved by Over 2,000+ Users.</p>
            <div>
                <a href="<?php echo esc_url( admin_url( 'edit.php?post_type=officeviewer&page=embed-office-viewer-pricing' ) ) ?>" class="button button-primary" target="_blank">Upgrade To Pro <svg enable-background="new 0 0 515.283 515.283" height="16" viewBox="0 0 515.283 515.283" width="16" xmlns="http://www.w3.org/2000/svg">
                        <g>
                            <g>
                                <g>
                                    <g>
